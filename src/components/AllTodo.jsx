...
const AllTodo = (props: any) => {
  return (
    <div
      className={`${props.windowSize.innerWidth < 650 ? "min" : "widthAd"}
      
      mx-auto`}
    >
      <ul className="relative ">
        {props.todo.map((todoData: any, index: number) => {
          return (
            <>
              <li
                key={todoData.id}
              ...
              >
                {/* <div className="checkbox-container w-5 h-5 rounded-full absolute mt-10 "></div> */}
                <div
                  className={`${
                ...
                <div>
                  ...
                  >
                    {props.selection === "All" ? todoData.todo : ""}
                  </span>
